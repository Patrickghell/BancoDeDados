...
{
    public partial class FuncionarioVisualizar : Form
    {
        public FuncionarioVisualizar()
        {
            ...
            consulta.CommandText = "SELECT * FROM funcionario";
            ...
            if (resultado.HasRows)
            {
                ...
                {
                    dataGridView1.Rows.Add(resultado["codfunc"].ToString(),
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand consulta = new MySqlCommand();
            consulta.Connection = conectar;
            consulta.CommandText = "SELECT * FROM funcionario WHERE " + campo + " like '%" + nomecampo + "%'";
