...
namespace Banco_de_dados_ds
{
    ...
    {
        public string id = "";
        public FuncionarioAlterar(string i)
        {
            InitializeComponent();
            id = i;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conectar.Open();
            MySqlCommand consulta = new MySqlCommand();
            string inserir = "UPDATE funcionario SET nome ='" + textBox1.Text + "', rg ='" + textBox2.Text + "', cpf ='" + textBox3.Text + "', endereco ='" + textBox4.Text + "', cidade ='" + textBox5.Text + "', email ='" + textBox6.Text + "', telefone ='" + textBox7.Text + "' WHERE codfunc = " + id;
